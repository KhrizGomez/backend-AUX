...
**backend-AUX** es una API REST desarrollada con **Spring Boot 3.5** y **Java 25**, diseñada para servir como módulo auxiliar de un Sistema de Gestión Académica (SGA). Su función principal es gestionar y exponer los datos de los actores académicos de una institución educativa, incluyendo estudiantes, coordinadores, decanos, carrera, facultades y matrículas.
